      ...
      <main id="main-content" className="mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-20">
        ...
        <div className="prose text-foreground/90 space-y-4">
          ...
          <p>
            ...
            kategorie plików cookie się zgadzasz. Zgodnie z Google Consent Mode v2, domyślnie —
            zanim podejmiesz decyzję — wszystkie pliki niewymagane do działania Serwisu są
            wyłączone.
          </p>
          <ul className="list-disc pl-6">
            <li>
