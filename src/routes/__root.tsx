        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.05fr]">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-cream/80 sm:text-lg lg:mx-0">
              Wygląda na to, że ten lokal uciekł nam sprzed talerza albo jeszcze go nie odkryliśmy. Spróbuj sprawdzić adres lub wróć na główną i znajdź coś pysznego!
            </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Najlepsze restauracje w Poznaniu — mapa, oceny i rolki z Instagrama. Znajdź gdzie zjeść kebaba, ramen, śniadanie i więcej." },
      ...
      { property: "og:description", content: "Najlepsze restauracje w Poznaniu — mapa, oceny i rolki z Instagrama. Znajdź gdzie zjeść kebaba, ramen, śniadanie i więcej." },
      { name: "twitter:description", content: "Najlepsze restauracje w Poznaniu — mapa, oceny i rolki z Instagrama. Znajdź gdzie zjeść kebaba, ramen, śniadanie i więcej." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/328e3c76-a805-46b2-8e95-0dcc3a8a9155" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/328e3c76-a805-46b2-8e95-0dcc3a8a9155" },
      { name: "google-site-verification", content: "otoVs-bqss54Ne6ibX-Y8ik3re9mnh-tGFJ-TQbA0Ac" },
    ],
    links: [
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,500;12..96,600;12..96,700;12..96,800&family=Fraunces:wght@400;600;700;900&family=Manrope:wght@400;500;600;700&display=swap" },
      {
        rel: "stylesheet",
        href: appCss,
      },
