...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`fixed right-4 bottom-[calc(var(--pz-fab-bottom,4.75rem)+env(safe-area-inset-bottom))] z-30 grid h-11 w-11 place-items-center rounded-full border border-border bg-card/90 text-foreground shadow-md backdrop-blur transition-all duration-300 hover:border-tomato hover:text-tomato lg:bottom-6 lg:right-6 lg:h-11 lg:w-11 ${
